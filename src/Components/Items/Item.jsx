...
function Item({ product }) {
  return (
    <div className="bg-white shadow-md rounded-lg p-4 transition-transform transform hover:scale-105 w-60">
      {/* Product Image */}
      <img src={product.img ? product.img : ""} alt={product.name} className="w-full h-48 object-cover rounded-md" />
